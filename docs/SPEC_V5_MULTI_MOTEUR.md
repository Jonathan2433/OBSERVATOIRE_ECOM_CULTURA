...
- Recettes applicatives **V1 115/115, V3 13/13, V4 79/79, V5 115/115** restent vertes.
...
- [x] **Aucune régression** : `recette_v1` 115/115, `recette_v3` 13/13,
      `recette_v4` 79/79 et `recette_v5` 115/115 ; campagne locale au vert.
...
| **Régression du moteur LM Studio** lors d'une évolution de `llm_common` | Casse V4/V5 | Contrats sélectionnés par moteur + recettes V4 79/79 et V5 115/115. |
