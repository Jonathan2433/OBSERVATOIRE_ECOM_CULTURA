...
| **Definition of Done** | ☐ Comparaison ancien/nouveau produite sur le jeu de recette gelé · ☐ recette métier tenue et verdict prononcé par une personne nommée (Q-11) · ☐ recettes **V1 115/115, V3 13/13, V4 67/67, V5 115/115 et V6 42/42** au vert · ☐ débit vérifié sur un lot réel (ENF-1) · ☐ exports et écran de revue vérifiés avec le nouveau contrat de sortie · ☐ dashboards affichant les nouveaux KPI — **sous réserve de Q-15, charge non provisionnée** · ☐ modèle activé et activation tracée à l'audit (EF-12) · ☐ aucun couple hors référentiel produit par le modèle sur l'intégralité d'un lot · ☐ date effective de mise en production confirmée (Q-10) |
...
| **Contenu livré** | Prompts proposeur et raffineur `v2-cultura-2026`, taxonomie embarquée 11/59, revalidation des nouveaux libellés, repli canonique `Général / Autre`, plafonds 0,40/0,30 et normalisation D-26. Le mapper conserve uniquement les thèmes négatifs sur un cas mixte ; Claude reste sur V1. Le registre expose le référentiel et l'API sert celui du moteur final de la cascade. |
| **Livrable vérifiable** | `llm_common.py`, configuration LM Studio, registre/référentiel API, documentation et recettes V4 **67/67** + V5 **115/115**. |
| **Definition of Done** | ☑ Prompts réécrits et version incrémentée · ☑ taxonomie injectée à jour · ☑ revalidation 11/59 testée · ☑ garde-fous et repli vérifiés · ☑ divergence résolue selon D-26 · ☑ switch/registre testé sans service réel · ☐ lot réel traité sur un poste avec LM Studio |
...
| **Risques du lot** | Faible côté intégration. Reste une recette qualitative et de latence avec le modèle réellement chargé dans LM Studio. |
| **Statut** | **Développé le 18/09/2026** ; recette locale réelle LM Studio restant à prononcer. |
